  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ marginBottom: 30 }}>
        <Button title="Add Student" onPress={addStudent} color="#7E6C99" />
      </View>
      <View style={{ marginBottom: 30 }}>
        <Button title="View" onPress={() => navigation.navigate('Student List')} color="#7E6C99" />
      </View>
    </View>
  );
}
...
function StudentLists({ navigation }) {
  return (
    <View style={{ backgroundColor: 'white' }}>
      <StudentList />
      <Button title="Add Student" onPress={() => navigation.goBack()} color="#7E6C99" />
    </View>
  );
}
